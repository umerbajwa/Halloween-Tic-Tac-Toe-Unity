...
using UnityEngine;
using UnityEngine.UI; // using unity userinterface

public class GameStateController : MonoBehaviour // gamestate controller class is public clas that is being derived from monobehaviour class through inheritence
{
    [Header("TitleBar References")]
    public  Image playerXIcon;                                        // Reference to the playerPumpkin icon
    public Image playerOIcon;                                        // Reference to the playerSkull icon
    ...
    public Sprite tilePlayerO;                                       // Sprite reference to O(skull) tile
    public Sprite tilePlayerX;                                       // Sprite reference to X(pumpkin) tile
    ...
    public string playerTurn;                                       // Internal tracking whos turn is it
    public string player1Name;                                      // Player1 display name
    public string player2Name;                                      // Player2 display name
    ...
    /// [6][7][8]
    /// </summary>
    public void EndTurn() // Win and Lose function
    {
        moveCount++;
